...
abstract final class AppEnv {
  ...
  /// True when the Supabase credentials were never injected (no
  /// --dart-define-from-file). In this state the real backend cannot
  /// initialize, so the app boots into a self-contained DEMO build with
  /// sample data. A production build always provides these values, so demo
  /// mode is never reachable in a real release.
