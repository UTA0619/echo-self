 ...
 *
 * Used by the pattern-detect edge function (Claude Sonnet) to surface
 * recurring behavioral patterns across a user's last 30 days of
 * aggregated behavioral tags.
 */
...
export interface DetectedPattern {
  pattern_type: string       // e.g. "avoidance", "rumination", "growth-seeking"
  pattern_description: string
  frequency_days: number     // avg days between occurrences
  confidence: number         // 0.0–1.0
  trigger_tags: string[]     // which tags co-occur with this pattern
}
