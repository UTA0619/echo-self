 ...
 *
 * Used by the generate-daily-insight edge function.
 * Generates a short, highly personal insight from recent memory patterns.
 */

export interface DailyInsightParams {
  userName: string
  recentMemories: string[]        // last 7–14 memory chunks
  emotionArc: string              // e.g. "joy → trust → anticipation"
  topTags: string[]               // most frequent behavioral tags this week
  streakDays: number
}
