...
// Placeholder screens for EPIC-05+
...
export function MainTabNavigator() {
  return (
    ...
    >
      <Tab.Screen name="Mirror" component={DailyMirrorScreen}
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🪞" label="Mirror" focused={focused} /> }}
      />
      <Tab.Screen name="Timeline" component={TimelineScreen}
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="📊" label="Timeline" focused={focused} /> }}
      />
      <Tab.Screen name="FutureSelf" component={FutureSelfScreen}
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🔮" label="Future" focused={focused} /> }}
      />
